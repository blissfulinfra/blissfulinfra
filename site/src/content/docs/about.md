...
I wanted to go deeper. Wire Kafka up by hand, understand how authentication and authorization work, swap Redis for a Postgres read replica and see what actually changes. I also wanted to just spin it up. No two hour `docker-compose.yaml` detour, no cloud bill creeping up while I learn.
