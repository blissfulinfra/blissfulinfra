...
<CardGrid>
  <Card title="Learn" icon="open-book">
    Students, new grads, and engineers who want to understand how production systems work — without an AWS bill. A guided course through Kafka, Postgres, Keycloak, CI/CD, and observability. Run the same stack real engineering teams run, on your laptop.
  ...
  <Card title="Deliver" icon="puzzle">
    Indie studios and small teams shipping real products for clients. Per-client isolated stacks with Kafka, Postgres, observability, CI/CD, local AI inference, and project tracking — no cloud overhead, no SaaS bill.
